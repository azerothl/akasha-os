...
1. Copy a shipped recipe such as [`skills/planner/SKILL.md`](../skills/planner/SKILL.md).
...
([`LICENSE-MIT`](../LICENSE-MIT)). Une Discussion Show and tell reste valable
sans PR. Une PR ici ne doit pas toucher `crates/`. La marque Akasha OS reste
réservée.
