...
- **Transparency panel** : chain-of-custody des décisions agent (timeline `agent.trace`, sources agrégées, badge simple/complex). **Preview 0.3.0** : livré dans egui (onglet Agents + cartes chat).
...
| Observabilité / administration | F-OBS-01 → 05 | §9.3 Audit, §11.5 Admin API, §13 Métriques, Metrics Exporter (§3.1), E23 `health.*` | Couvert |
