...
| **E10** | **Marketplace MCP / modules locale** (catalogue signé, revue de caps) | Distribution type ClawHub sans devenir ClawHub | **E10-lite 0.4.0** — revue de caps + exemple MCP ; **catalogue local signé 0.6.0** ; **source extra Git signée opt-in** (`community/catalogue.yaml`, revue de caps, pas un store public) |
