...
| P05.3 | E14 UX | Settings toggle (default ON); post-turn hook; toast; Memory `chat` badge | done |
...
| P05.3 | Default ON: toast + Memory badge after a durable chat turn. OFF: zero writes. Delete from UI removes the fact |
