...
| **More (overflow)** | Notes · Tâches/Tasks (when installed) · Models · Settings · Caps · Audit · Providers · DeclUI modules · *(tester)* Scenarios · *(tester)* Feedback | Collapsible section. Tester-only surfaces are **not** peer tabs on the rail. |
