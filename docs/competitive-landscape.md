...
**Positioning:** an *agent-native* OS — agents, models, tools, and memory as first-class system services, not an app bolted onto POSIX. Preview 0.4.0 runs on a host; a separate seL4 track (PV.1–PV.3) scaffolds bare metal.
...
| Maturity | v0.10.0, broader product surface | Preview 0.4.0, deeper OS thesis |
...
| Product maturity | installable Preview 0.4.0 | ~20★, kernel boot yes, agent layer still scaffolding |
