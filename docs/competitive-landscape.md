...
**Akasha OS baseline:** Preview **0.6.0** host app (Windows/Linux + NVIDIA), not a bootable image. Sources: [README.md](../README.md), [FEATURES.md](FEATURES.md), [vision.md](vision.md), [functional-specs.md](functional-specs.md), [STATUS.md](STATUS.md).

---

## What Akasha OS is

**Positioning:** an *agent-native* OS — agents, models, tools, and memory as first-class system services, not an app bolted onto POSIX. Preview 0.6.0 runs on a host; a separate seL4 track (PV.1–PV.3) scaffolds bare metal.
...
| | Akasha (assistant) | Akasha OS (Preview 0.6.0) |
|--|--------------------|---------------------------|
...
| Maturity | v0.10.0, broader product surface | Preview 0.6.0, deeper OS thesis |
...
| Product maturity | installable Preview 0.6.0 | ~20★, kernel boot yes, agent layer still scaffolding |
