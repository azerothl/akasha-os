...
**Akasha OS baseline:** Preview **0.3.0** host app (Windows/Linux + NVIDIA), not a bootable image. Sources: [README.md](../README.md), [FEATURES.md](FEATURES.md), [vision.md](vision.md), [functional-specs.md](functional-specs.md), [STATUS.md](STATUS.md).

---

## What Akasha OS is

**Positioning:** an *agent-native* OS — agents, models, tools, and memory as first-class system services, not an app bolted onto POSIX. Preview 0.3.0 runs on a host; a separate seL4 track (PV.1–PV.3) scaffolds bare metal.
...
**Not in Preview:** bootable image, macOS / CPU-only, marketplace, multi-user, full multi-GPU, native audio/video.
...
| | Akasha (assistant) | Akasha OS (Preview 0.3.0) |
|--|--------------------|---------------------------|
...
| Dual-surface modules | WASM plugins (tools) | `.aospkg` human + agent (notes) |
| UI | TUI + Tauri React | native egui |
| License | proprietary | AGPL + commercial |
| Maturity | v0.10.0, broader product surface | Preview 0.3.0, deeper OS thesis |
...
| Product maturity | installable Preview 0.3.0 | ~20★, kernel boot yes, agent layer still scaffolding |
...
Prioritized product responses (E1–E13, anti-roadmap): [evolution-roadmap.md](evolution-roadmap.md).
