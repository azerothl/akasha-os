# Community — Akasha OS Preview 0.16.0
...
**Title:** Preview cohort 0.16.0 — looking for 3 Windows + 1 Linux + 1 Mac

```
Akasha OS Preview 0.16.0 is an installable host app (Windows / Linux x64,
...
```
La Preview 0.16.0 d’Akasha OS est une appli hôte installable (Windows /
