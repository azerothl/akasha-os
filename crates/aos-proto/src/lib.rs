...
pub use rich_app_contract::{
    BUDGET_ACTION_COMMIT_P95_MS, BUDGET_BINDING_REFRESH_P95_MS, BUDGET_JOB_PROGRESS_FIRST_MS,
    BUDGET_JOB_PROGRESS_MAX_HZ, BUDGET_LOCAL_INTERACTION_P95_MS, CREATE_DOCUMENTS_PREFIX,
    CREATE_FS_READ_CAP, CREATE_FS_WRITE_CAP, CREATE_TARGET_UI_CONTRACT, FS_READ_DOWNLOADS_CAP,
    FS_WRITE_DOWNLOADS_CAP, HOST_UI_CONTRACT_MAX, ILLUSTRATION_DOCUMENTS_PREFIX,
    ILLUSTRATION_FS_READ_CAP, ILLUSTRATION_FS_WRITE_CAP, INTERACTION_PHASES, JOBS_SERVICE_VERSION,
    ...
    PLATFORM_MEDIA_IMAGE_METHODS, REFERENCE_MACHINE_NOTE, RENDER_BLENDER_CAP, RENDER_CPU_CAP,
    RENDER_RESULT_SERVICE, RENDER_STATUS_SERVICE, RENDER_STUB_CAP, RENDER_STUB_SERVICE,
    RENDER_SUBMIT_SERVICE, ASSET_ILLUSTRATION_READ_CAP, ASSET_INSTANTIATE_SERVICE,
    ILLUSTRATION_ASSETS_PREFIX, MESH_ASSIST_SERVICE, MESH_PACK_STATUS_SERVICE, MESH_NEURAL_CAP,
    RENDER_PACK_STATUS_SERVICE,
    ILLUSTRATION_DEPENDENCIES_INSTALL_SERVICE, ILLUSTRATION_DEPENDENCIES_INSTALL_CAP,
    ILLUSTRATION_ASSET_IMPORT_SERVICE, ILLUSTRATION_ASSET_IMPORT_CAP,
    COMIC_LAYOUT_CAP, COMIC_LAYOUT_SERVICE, COMIC_RENDER_CAP, COMIC_RENDER_SERVICE,
    STORYBOARD_EDIT_CAP, STORYBOARD_CAPTURE_SERVICE, STORYBOARD_APPLY_SERVICE,
    STORYBOARD_DELETE_SERVICE, STORYBOARD_MOVE_SERVICE,
    ASSET_PACK_LIST_SERVICE, ASSET_PACK_DESCRIBE_SERVICE, ASSET_MARKETPLACE_FETCH_SERVICE,
    NETWORK_FETCH_CAP, SCENE_COMPOSE_CAP,
    SCENE_COMPOSE_SERVICE, SCENE_POSE_CAP, SCENE_POSE_SERVICE, SCENE_EDIT_CAP, SCENE_LOCK_CAP,
    SCENE_GET_SERVICE, SCENE_SELECT_SERVICE, SCENE_TRS_SERVICE, SCENE_CAMERA_SERVICE,
    SCENE_LIGHT_SERVICE, SCENE_APPLY_SERVICE,
    SCENE_LOCK_SERVICE, SCENE_UNLOCK_SERVICE, SCENE_LOCKS_SERVICE, RICH_UI_DOCUMENT,
    SERVICES_JOBS_FIELD, SERVICES_MEDIA_IMAGE_FIELD,
...
pub enum ChatAttachment {
    ...
    /// Video generated by the local media engine (usually WebM in Preview).
    Video {
        path: String,
        #[serde(default)]
        prompt: String,
