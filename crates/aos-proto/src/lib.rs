...
pub use rich_app_contract::{
    ...
    ILLUSTRATION_ASSETS_PREFIX, SCENE_COMPOSE_CAP, SCENE_COMPOSE_SERVICE, SCENE_POSE_CAP,
    SCENE_POSE_SERVICE, SCENE_EDIT_CAP, SCENE_LOCK_CAP, SCENE_GET_SERVICE, SCENE_SELECT_SERVICE,
    SCENE_TRS_SERVICE, SCENE_APPLY_SERVICE, SCENE_LOCK_SERVICE, SCENE_UNLOCK_SERVICE,
    SCENE_LOCKS_SERVICE, RICH_UI_DOCUMENT, SERVICES_JOBS_FIELD, SERVICES_MEDIA_IMAGE_FIELD,
