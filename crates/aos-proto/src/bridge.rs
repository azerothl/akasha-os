...
pub fn memory_schema_document() -> Value {
    json!({
        ...
        "$defs": defs(&[
            ...
            ("MemExplainRequest", schema_of::<MemExplainRequest>()),
            ("MemExplanation", schema_of::<MemExplanation>()),
            ("MemGraphQueryRequest", schema_of::<MemGraphQueryRequest>()),
            ("MemGraphResponse", schema_of::<MemGraphResponse>()),
            ...
            ("MemObjectListRequest", schema_of::<MemObjectListRequest>()),
            ...
            ("MemSweepRequest", schema_of::<MemSweepRequest>()),
            ("MemSweepResponse", schema_of::<MemSweepResponse>()),
            ("MemSweepStatus", schema_of::<MemSweepStatus>()),
            ("MemTimelineRequest", schema_of::<MemTimelineRequest>()),
            ("MemTimelineResponse", schema_of::<MemTimelineResponse>()),
            ...
            ("MemoryObject", schema_of::<MemoryObject>()),
            ("MemoryObjectKind", schema_of::<MemoryObjectKind>()),
            ("MemoryObjectStatus", schema_of::<MemoryObjectStatus>()),
            ("MemoryRelationKind", schema_of::<MemoryRelationKind>()),
            ("MemoryRelationV2", schema_of::<MemoryRelationV2>()),
            ("MemorySourceRef", schema_of::<MemorySourceRef>()),
            ("MemoryTemporal", schema_of::<MemoryTemporal>()),
        ]),
    })
}
