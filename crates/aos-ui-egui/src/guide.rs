...
const EN: GuideStrings = GuideStrings {
    ...
    chat_opt_documents_body: "On a research-style question, choose Reply for a short answer in chat, or Prepare a document for a structured file under /downloads/documents/. While it runs you see Writing your document… with live steps and Stop; when ready, Open shows the document in a clamped overlay. Generated documents are added to the Library (More → Library) and indexed for chat context.",
    chat_opt_documents_example: "\"What's the state of agentic apps?\" → Prepare a document → Writing your document… → Ready → Open; find it again under Library.",
    ...
    canvas_opt_tools_body: "Pen, Eraser, Line, Spline, Rect, Ellipse, Text, Bucket; Tint, Width, Fill. Undo my stroke; Clear asks first. Format: Square, 16:9, 16:10, Vertical, Horizontal.",
...
const FR: GuideStrings = GuideStrings {
    ...
    chat_opt_documents_body: "Sur une question de recherche, choisissez Répondre pour une courte réponse dans le chat, ou Préparer un document pour un fichier structuré sous /downloads/documents/. Pendant la rédaction : Rédaction du document… avec Arrêter ; une fois prêt, Ouvrir affiche le document dans une fenêtre calée au viewport. Les documents générés sont ajoutés à la Bibliothèque (Plus → Bibliothèque) et indexés pour le chat.",
    chat_opt_documents_example: "« Quel est l'état de l'art des apps agentic ? » → Préparer un document → Rédaction du document… → Prêt → Ouvrir ; retrouvez-le dans Bibliothèque.",
    ...
    canvas_opt_tools_body: "Crayon, Gomme, Ligne, Courbe, Rectangle, Ellipse, Texte, Seau ; Teinte, Épaisseur, Plein. Annuler mon trait ; Tout effacer demande confirmation. Format : Carré, 16:9, 16:10, Vertical, Horizontal.",
