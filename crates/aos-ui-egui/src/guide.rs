...
const EN: GuideStrings = GuideStrings {
    ...
    chat_opt_documents_body: "On a research-style question, choose Reply for a short answer in chat, or Prepare a document for a structured file under /downloads/. While it runs you see Researching… with Stop; when ready, Open shows the document in a clamped overlay. Generated documents are added to the Library (More → Library) and indexed for chat context.",
