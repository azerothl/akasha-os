        ...
        if section_visible(
            ...
            egui::Grid::new("settings_models")
                ...
                .show(ui, |ui| {
                    ...
                    ui.vertical(|ui| {
                        if ui
                            .checkbox(&mut self.prefs.adaptive_planner, t.providers_enabled)
                            .changed()
                        {
                            save_preferences(&self.prefs);
                            self.status =
                                format!("{} — {}", t.settings_saved, t.adaptive_planner_hint);
                        }
                ...
                |ui| {
                    egui::Grid::new("settings_image_defaults")
                        ...
                        .show(ui, |ui| {
                            ...
                            ui.horizontal(|ui| {
                                ui.add(
                                    egui::DragValue::new(&mut self.prefs.image_width)
                                        .range(64..=2048),
                                );
                                ui.add(
