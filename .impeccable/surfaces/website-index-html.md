...
- **Proof / content:** Real facts only — Preview 0.5.0 host app, capability grants, NVIDIA recommended / CPU path, not bootable, install scripts, repo docs, dual license.
...
- **Memorable moment:** Live orrery (MEMORY, CAPS, GPU, AGENTS); HOST / NVIDIA / NOT BOOTABLE as one cyan swipe on void; INSTALL winds the machine.
