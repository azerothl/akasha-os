...
- **Proof / content:** Real facts only — Preview 0.6.0 host app, capability grants, NVIDIA recommended / CPU path, not bootable, install scripts, repo docs, dual license.
